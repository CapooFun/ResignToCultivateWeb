...
> **v0.1.0 已锁定**（2026-08-04）：第一个可分享 Demo。非正式成品；下一轮再开迭代。  
...
版本快照：[项目管理/30_📦版本快照/2026-08-04_v0.1.0_首版.md](./项目管理/30_📦版本快照/2026-08-04_v0.1.0_首版.md)

**本地试玩**：本工程 `npm run dev -- --port 5180`（5173 常被梅凝工作台占用）。
